...
<body>
    ...
    <div class="container">
        ...
        <div class="back-arrow"><a href="studentlist.php" style="margin-right: 100%; "><strong><span class="material-symbols-outlined">arrow_back_ios</span></strong></a></div>
        ...
        <div class="student-info">
            <?php if ($studentInfo): ?>
                ...
                <div>
                    ...
                    <?php  
                    if ($studentInfo['major'] == null) {
                       
                    } else{
                    ?>
                    <strong>Major:</strong> <?php echo htmlspecialchars($studentInfo['major']); ?><br>
                <?php } ?>
        ...
        <div class="filter">
            ...
            <a class="add-record-btn" href="addrecord.php?id=<?php echo htmlspecialchars($id); ?>">Add Record</a>
        </div>
        <table>
            <?php 
                    ...
                    foreach ($studentRecords as $record) {
                        if ($record['semester'] == $semester) {
                            if (!$hasRecords) {
                                $hasRecords = true;
                                echo "<thead>";
                                echo "<tr><th colspan='8'>Semester: {$semester}</th></tr>";
                                echo "<tr>";
                                echo "<th>Code</th>";
                                echo "<th>Subject</th>";
                            ...
                            echo "<a href='edit_record.php?id=" . htmlspecialchars($record["student_id"]) . "&ids=" . htmlspecialchars($record["id"]) . "' class='edit'>Edit</a>";
                            echo "</td>";
                            echo "</tr>";
                        }
                    }
    ...
    <script>
        function filterByYear(year) {
            ...
            window.location.href = 'view_student.php?id=' + studentId + '&year=' + year;
        }
    </script>
</body>
</html>
