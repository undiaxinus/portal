...
$idsss = isset($_GET['idsss']) ? $_GET['idsss'] : '';
...
<body>
    ...
    <div class="container" style="margin-left: 100px;">
        ...
        <div class="back-arrow"><a href="record.php?id=<?php echo $id ?>" style="margin-right: 100%; "><strong><span class="material-symbols-outlined">arrow_back_ios</span></strong></a></div>
        ...
        <table>
            ...
            foreach ($studentRecords as $record) {
                if ($ids == $record['Course'] && $idss == $record['Year'] && $idsss == $record['Major']) {
                    if (!$hasRecords) {
                        $hasRecords = true;
                        echo "<thead>";
