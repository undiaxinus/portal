    ...
    <script>
        function confirmDelete(studentId) {
            ...
            document.getElementById('deleteButton').onclick = function() {
                window.location.href = 'delete_course.php?id=' + studentId;
            }
        }
...
<body>
    ...
    <div class="center">
        ...
        <div style="text-align: center; margin-bottom: 20px;">
            <a href="addcourse.php" style="padding: 10px 20px; background-color: #4CAF50; color: white; text-decoration: none; border-radius: 4px;">Add New Course</a>
        </div>
        <table>
            <tr>
                <th colspan="8"><center><h2 style="text-align: center;">Courses</h2></center></th>
            </tr>
            <tr>
                <th>Course</th>
                <th>Major</th>
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<td class='buttons'>
                            <a href='sub_sched.php?id=" . $row["course"] . "&ids=" . $row["major"] . "&idss=" . $row["year"] ."' class='view'>View</a>
