...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (move_uploaded_file($picture["tmp_name"], $target_file)) {
        // Prepare and bind
        $stmt = $conn->prepare("INSERT INTO student (name, student_id, address, picture, year, course, major) VALUES (?, ?, ?, ?,?,?,?)");
        $stmt->bind_param("sssssss", $name, $student_id, $address, $target_file, $year, $course, $major);
		...
		<form action="" method="post" enctype="multipart/form-data">
			<table>
				...
				<tr>
					<th>Picture:</th>
					<th>
						<input type="file" name="picture" id="Profile" required accept="image/*" onchange="displayImage(this)">
						<img id="profileDisplay" src="images/OIP.jpg" alt="Profile Picture">
					</th>
				</tr>
				<tr>
