...
<body>
    ...
    <div class="center">
        ...
        <div style="text-align: center; margin-bottom: 20px;">
            <a href="addstudentrecord.php" style="padding: 10px 20px; background-color: #4CAF50; color: white; text-decoration: none; border-radius: 4px;">Add New Student</a>
        </div>
        <table>
            <tr>
                <th colspan="8"><center><h2 style="text-align: center;">Student List</h2></center></th>
            </tr>
            <tr>
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<td><img src='" . $row["picture"] . "' alt='Profile Picture'></td>";
                    echo "<td class='buttons'>
                            <a href='view_student.php?id=" . $row["student_id"] . "' class='view'>View</a>
